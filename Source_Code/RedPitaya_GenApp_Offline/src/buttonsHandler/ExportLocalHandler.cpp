...
namespace ExportLocalHandler
{
                ...
                DetailsPanel &detailsPanel)
    {
        ...
        selectDialog->signal_response().connect([parentWindow, &buttonExportLocally, &cancelExportButton, &detailsPanel, &modelFolder, &genFilesDir, &cancelExportFlag, selectDialog](int response)
                                                {
            ...
            folderDialog->signal_response().connect([parentWindow, &buttonExportLocally, &cancelExportButton, &detailsPanel, &modelFolder, &genFilesDir, selectedVersions, &cancelExportFlag, folderDialog](int response)
            {
